...
$(".pagination li.current-page").on("click", function () {
  ...
  if ($(this).hasClass('active')) {
    ...
    const grandTotal = limitPerPage * currentPage; // Get the total number of items up to the page number that was clicked on
...
$("#next-page").on("click", function () {
  ...
  if (currentPage === totalPages) {
    ...
    $("#page .list-group-item").hide(); // Hide all items in the pagination loop
    const grandTotal = limitPerPage * currentPage; // Get the total number of items up to the page that was selected
